...
class FinalWin(QWidget):
    ...
    def initUI(self):
        ...
        self.indexs = QLabel(txt_index + str(self.index))
        self.layoutV = QVBoxLayout()
        self.layoutV.addWidget(self.indexs, alignment=Qt.AlignCenter)
        self.layoutV.addWidget(self.work_heart, alignment=Qt.AlignCenter)
